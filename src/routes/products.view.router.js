...
routerViewProducts.get("/", async (req, res) => {
        ...
        return res.render('home', { title: "Products", products: products, userCart: userCart, pagingCounter: limitedProducts.pagingCounter, totalPages: limitedProducts.totalPages, page: limitedProducts.page, hasPrevPage: limitedProducts.hasPrevPage, hasNextPage: limitedProducts.hasNextPage, prevPage: limitedProducts.prevPage, nextPage: limitedProducts.nextPage} );
    }
});
