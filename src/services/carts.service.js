...
export class CartService {
    ...
    async getCartById(id) {
        try{
            ...
            CustomError.createError({
                name: "cart not found",
                message: `the cart with the id: ${id} was not found`,
    ...
    //borrar todos los products  del carrito 
    async clearCart(cid) {
        try{
            ...
            CustomError.createError({
                name: "cart not found",
                message: `the cart with the id: ${cid} was not found`,
                code: EErrors.NOT_FOUND,
            });
        next(error)
        }
    ...
    async purchaseCart(cartId) {
        try {
            ...
            if (purchasedProducts.length > 0) {
                ...
                return {
                    success: false,
                    message: 'The chosen product is out of stock or the cart is empty'
                };
            }
        } catch (error) {
            return {
